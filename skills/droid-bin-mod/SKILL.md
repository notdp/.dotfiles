...
| 补偿 | 死代码区域   | 多处死代码        | 注释/缩短填充     | -66  | 统一补偿 mod9(+66)                      |
...
mod9 产生 +66 bytes，由 `comp_universal.py 66` 统一补偿。
...
用法：`python3 comp_universal.py 66` 补偿 mod9(+66) 的 +66 bytes。
...
python3 ~/.factory/skills/droid-bin-mod/scripts/compensations/comp_universal.py 66  # 补偿 mod9(+66)

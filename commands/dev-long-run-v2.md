...
加载 `skills/dev-long-run-v2/SKILL.md` 并执行对应子命令。harness: `skills/dev-long-run-v2/lr2.py`。

子命令直通 `python3 skills/dev-long-run-v2/lr2.py <args>`：
...
无参数或不确定子命令时，读 `skills/dev-long-run-v2/SKILL.md` 与 `docs/specs/dev-long-run-v2/overview.md` 后再决定。

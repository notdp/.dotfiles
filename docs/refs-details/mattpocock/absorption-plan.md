...
| MP-5 | Durable Agent Brief 模板 | `think-plan`、`dev-long-task-scaffold`、`dev-long-run` | L4 | P2 |
...
| MP-12 | Vertical slice 计划语言 | `think-plan`、`dev-long-task-scaffold`、`dev-long-run` | L4 | P2 |
...
**What**: 在 `think-plan`、`dev-long-task-scaffold`、`dev-long-run` 中引入长期交接产物模板。
...
**What**: 在 `think-plan`、`dev-long-task-scaffold`、`dev-long-run` 中，phase/issue 拆分采用 vertical slice 语言。

...
```bash
"${HOME}/.dotfiles/scripts/scan_operational_task_contract.py" --strict
```

不要假设目标项目有 `${HOME}/.dotfiles/scripts/scan_operational_task_contract.py`；该 helper 来自 dotfiles，运行 cwd 才是目标仓库。

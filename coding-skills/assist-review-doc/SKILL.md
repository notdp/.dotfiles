...
```bash
python3 "<dotfiles_root>/scripts/review_doc_render.py" --doc <doc.md> --output <doc>.review.html
# 写空 comments.json
...
```
1. 跑 <dotfiles_root>/scripts/review_doc_consume.py diff --baseline <git.json> --incoming <download.json>
...
4. 跑 <dotfiles_root>/scripts/review_doc_ids.py verify <doc.md> <comments.json>  # 校验无 orphan anchor
